...
portfolioHoldings=[
    ['','Cost basis($)','Value on\n'+str(portfolioDate), 'Unrealized\ngain/loss($)', 'Unrealized\ngain/loss(%)','Est. annual\nincome($)','Current\nyield(%)','% of\nPortfolio'],
    ['Cash']+cash,
    ['Fixed Income']+FI,
    ['Equity']+Equity,
    ['Commodities']+Commodities,
    ['Non-Traditional']+NonTrad,
    ['Total Portfolio']+[ round(a+b+c+d+e,2) for (a,b,c,d,e) in zip(cash,FI,Equity,Commodities,NonTrad) ]
]
